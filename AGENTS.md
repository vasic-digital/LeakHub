# AGENTS.md -- digital.vasic.leakhub
...
Prompt-leak corpus / defensive-use fixtures (red-team training).

## Primary consumer

HelixAgent (`dev.helix.agent`). See the consuming-side Phase-A spec
at `docs/superpowers/specs/2026-04-21-elder-plinius-phaseA-go-leakhub.md` in the HelixAgent repository.
