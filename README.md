...
Prompt-leak corpus / defensive-use fixtures (red-team training). Once Phase-A is authorised and implemented the module will
...
- Future: see the Phase-A plan in the consuming HelixAgent repo at
  `docs/superpowers/specs/2026-04-21-elder-plinius-phaseA-go-leakhub.md`.
...
Original research corpus: `docs/research/go-elder-plinius-v3/go-elder-plinius/go-leakhub/`
...
This scaffold's `go.mod` declares the module as `digital.vasic.leakhub` and
